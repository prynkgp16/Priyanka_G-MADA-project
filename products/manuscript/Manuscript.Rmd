...
Relationship between ethnicity and social vulnerability
...
figure_plot = here("results","West_state_data_plot.png")
  ggsave(filename = figure_plot, plot=p1)
...
figure_plot2 = here("results","Midwest_state_data_plot.png")
   ggsave(filename = figure_plot2, plot=p2)
...
figure_plot3 = here("results","South_state_data_plot.png")
   ggsave(filename = figure_plot3, plot=p3)
...
figure_plot4 = here("results","Northeast_state_data_plot.png")
    ggsave(filename = figure_plot4, plot=p4)
